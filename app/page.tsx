...
export default function Page() {
  return (
    <main className="min-h-screen bg-white text-slate-900">
      ...
      {/* HERO */}
      <section className="max-w-[1600px] mx-auto px-8 py-16 grid md:grid-cols-2 gap-16 items-center">
      ...
      {/* SERVICES */}
      <section id="services" className="max-w-[1600px] mx-auto px-6 py-14">
      ...
      {/* PROCESS */}
      <section id="process" className="max-w-[1600px] mx-auto px-6 py-14">
